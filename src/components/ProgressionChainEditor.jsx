            ...
            <div key={i} className="flex items-center gap-1.5 bg-bg-main/40 dark:bg-bg-main-dark/40 p-1.5 rounded-md border border-border-card/30 dark:border-border-card-dark/30">
              <div className="flex items-center gap-1">
                <input
                  ...
                  className="h-7 w-9 rounded border border-input bg-bg-card dark:bg-bg-card-dark text-center text-xs font-mono focus:outline-none focus:ring-1 focus:ring-primary px-0 text-text-main dark:text-text-main-dark" />
              ...
              <div className="flex items-center gap-1">
                <input
                  ...
                  className="h-7 w-9 rounded border border-input bg-bg-card dark:bg-bg-card-dark text-center text-xs font-mono focus:outline-none focus:ring-1 focus:ring-primary px-0 text-text-main dark:text-text-main-dark" />
                <span className="text-[10px] text-text-secondary shrink-0">次/组</span>
              </div>
